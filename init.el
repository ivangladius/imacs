...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dap-mode hexrgb auto-sudoedit ccls company counsel disaster doom-themes evil-collection go-mode golang-mode lsp-haskell lsp-ivy lsp-pyright lsp-ui pdf-tools perspective projectile quickrun realgud smartparens smex vterm which-key yasnippet))
