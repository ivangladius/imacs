...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-java company straight corfu ace-window evil-easymotion perspective realgud pdf-tools auto-sudoedit vterm quickrun disaster smex counsel evil-collection evil doom-themes which-key))
